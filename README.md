...
Miners are incentivized through a winner-takes-all reward system. The best optimizations are grouped together, and the one submitted first is selected as winner. Every day at 12PM EST a contest is run.
